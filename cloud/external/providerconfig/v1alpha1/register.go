...
type ExtProviderConfigCodec struct {
...
func addKnownTypes(scheme *runtime.Scheme) error {
	scheme.AddKnownTypes(SchemeGroupVersion,
		&ExtMachineProviderConfig{},
	)
	scheme.AddKnownTypes(SchemeGroupVersion,
		&ExtClusterProviderConfig{},
	)
	return nil
}
...
func NewCodec() (*ExtProviderConfigCodec, error) {
...
func (codec *ExtProviderConfigCodec) ClusterProviderFromProviderConfig(providerConfig clusterv1.ProviderConfig) (*ExtClusterProviderConfig, error) {
	var config ExtClusterProviderConfig
...
func (codec *ExtProviderConfigCodec) DecodeFromProviderConfig(providerConfig clusterv1.ProviderConfig, out runtime.Object) error {
...
func (codec *ExtProviderConfigCodec) EncodeToProviderConfig(in runtime.Object) (*clusterv1.ProviderConfig, error) {
